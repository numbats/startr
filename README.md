...
NOTE: The instructions below are relatively generic. See [#6 Jun/Jul 2024 Modules Development Sprint](https://github.com/numbats/startr/issues/6) for specific instructions.
...
Once you have finished your module, submit a pull request to the relevant issue branch on `numbats/startr/` repository.

6. **Submit your Changes for Review**: If you go to your repository on GitHub, you’ll see a `Compare & pull request` button. Click on that button. Make sure to change the target repo to `numbats/startr` with the correct issue branch (e.g. `13-add-basic-tidyrdplyr`). Now submit the pull request.
