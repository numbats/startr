...
This allows you to sort your data based on one or more variables. By default, it will arrange your data in ascending order. If you want to sort by descending order, it can be done using the `desc()` function.
...
What do you think will happen to the data if you sort the penguin's data on the species where it is a character variable? If you guess that it will sort in alphabetical order, you are correct!!!
:::
...
What if there is an errors in the records where
...
::: {.callout-caution}
## Your turn!
Let said that you think that the body mass of the penguins should be expressed as kilogram instead of gram. How could you modify the existing variable.

Hint: The conversion from gram to kilogram can be expressed in a forms of
:::
