...
```{r}
knitr::include_graphics("resources/project_1.png")
```
...
```{r}
knitr::include_graphics("resources/project_2.png")
```
...
```{r}
knitr::include_graphics("resources/project_3.png")
```
...
```{r}
knitr::include_graphics("resources/project_4.png")
```

5. Click "Create Project".

```{r}
knitr::include_graphics("resources/project_5.png")
```
...
```{r}
knitr::include_graphics("resources/disable_store.png")
```