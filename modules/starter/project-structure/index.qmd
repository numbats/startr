...
results <- function() lapply(Filter(\(x) inherits(x, "result"), .evaluate_result), `[[`, "value")
errors <- function() vapply(Filter(\(x) inherits(x, "error"), .evaluate_result), `[[`, character(1L), "message")
warnings <- function() vapply(Filter(\(x) inherits(x, "warning"), .evaluate_result), `[[`, character(1L), "message")
messages <- function() vapply(Filter(\(x) inherits(x, "message"), .evaluate_result), `[[`, character(1L), "message")
