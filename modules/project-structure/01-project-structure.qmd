...
4. Give your project (and the folder that will contain it) a name using the "Directory name:" field. You can also choose where the project will exist on your computer. It can be done by clicking on the "Browse..." button. If you do not choose, it will be in your home directory. You can leave the rest unticked for now.
...
Save the workspace means that it stores all of the objects you've created for the next time you open the project. It may sound tempting to do it, but it is bad for reproducibility. All objects in the environment should be produced with code, and the code should be saved in the project
