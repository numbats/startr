...
An R project will allow RStudio to set the working directory correctly, handling all of the relative paths to the project folder for us. It also encourages you to organise the file structure properly by putting all the files used by that project inside the same folder.
