...
# check if 'dput' is called with 'head(penguins)' as its argument
dput_called_with_head_penguins <- search_ast(.code, .expr = dput(head(penguins)))

# check with feedback
feedback <- c(
  "Did you use dput() with head(penguins)?" = dput_called_with_head_penguins
)
