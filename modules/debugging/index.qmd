...
If you're often encountering situations where you need to use this strategy, it might be a sign of a code styling issue. You might benefit from writing your code in smaller pieces, rather than trying to do everything in one line (or chain) of code. Some tips on good code can be found in [Jenny Bryan's presentation 'Code Smeels and Feels](https://www.youtube.com/watch?v=7oyiPBjLAWY).
