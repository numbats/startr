...
[**GitHub**](https://github.com/). If you've thoroughly investigated your error and believe the issue lies in the package rather than your code, you can contact the package's developer. Most R packages are open-source and maintained on Github. Search for the package's repository using its name along with "R" and "GitHub", then use the "Issues" tab to report your problem. Make sure to check if the issue has already been reported before creating a new one.

**Discussion forum on Moodle or** [**Ed**](http://edstem.org). 
